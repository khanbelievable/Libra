...
EXPECTED = {
    "healthy": {
        ...
        "bronze_invoices": 720,
        "silver_invoices": 720,
        "quarantine": {"shipments": 0, "invoices": 0, "budgets": 0},
        "failed_rules": (),
        "revenue": "916351.47",
    },
    "duplicate_invoices": {
        ...
        "bronze_invoices": 732,
        "silver_invoices": 720,
        "quarantine": {"shipments": 0, "invoices": 12, "budgets": 0},
    ...
    "missing_gbp_fx": {
        ...
        "bronze_invoices": 720,
        "silver_invoices": 708,
        "quarantine": {"shipments": 12, "invoices": 12, "budgets": 2},
    ...
    "incomplete_germany": {
        ...
        "bronze_invoices": 619,
        "silver_invoices": 576,
        "quarantine": {"shipments": 0, "invoices": 43, "budgets": 0},
