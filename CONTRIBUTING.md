...
- For Spark changes, compare financial control totals to the deterministic local Gold oracle.
- For bundle changes, preserve the three-task job boundary and never commit workspace credentials.
